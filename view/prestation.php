    ...
    <div class="prestation">
        ...
        <div class="offer">
            <div class="individuals">
                ...
                <input class="buttonService" type="submit" value="les tarifs pour les particuliers">
                </form>
            </div>
            <div class="individuals">
                <h3>Entreprises</h3>
                ...
                Pourquoi ne pas organiser des ateliers bien-être dans votre entreprise, 
                afin de contribuer au bien-être au travail de vos salariés?</p>
                <form action="index.php" method="get">
                <input type="hidden" name="action" value="entreprise">
                <input class="buttonService" type="submit" value="les prestations pour les entreprises">
                </form>
                </div>
